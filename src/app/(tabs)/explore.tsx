...
const s = StyleSheet.create({
  ...
  prodCard: {
    width: '47%', backgroundColor: '#fff', borderRadius: 14, overflow: 'hidden',
  ...
  prodImg: { height: 118, backgroundColor: '#fff7f5', alignItems: 'center', justifyContent: 'center', position: 'relative' },
  wishBtn: {
    position: 'absolute', top: 8, right: 8, width: 30, height: 30,
    backgroundColor: 'rgba(255,255,255,0.95)', borderRadius: 15,
